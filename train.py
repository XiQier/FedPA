...
parser.add_argument('--video_feature_bin_flag', type=bool, default=False)
...
parser.add_argument('--lora_user_features', type=str, default='follow_user_num')
...
# Split private user's train/val/test dataset.
logging.info('Split the private user dataset')
...
selected_user_feature_file_dir = './dataset/' + str(config['dataset']) + '/_selected_user_feature_dict.txt'
selected_user_features = read_feature_names(selected_user_feature_file_dir)
selected_video_feature_file_dir = './dataset/' + str(config['dataset']) + '/_selected_video_feature_dict.txt'
